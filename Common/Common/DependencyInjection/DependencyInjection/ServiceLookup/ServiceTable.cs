                ...
                if (serviceTypeInfo.IsGenericTypeDefinition) {
                    ...
                    if (implementationTypeInfo == null ||
                        ...
                        throw new ArgumentException(
                            nameof(implementationTypeInfo)+"实例类型异常。");
                    }

                    if (implementationTypeInfo.IsAbstract ||
                        implementationTypeInfo.IsInterface) {
                        throw new ArgumentException(nameof(implementationTypeInfo) + "实例类型异常。");
                    }
                    ...
                    if (implementationTypeInfo.IsGenericTypeDefinition ||
                        ...
                        implementationTypeInfo.IsInterface) {
                        throw new ArgumentException(nameof(descriptor)+"实例类型异常。");
                    }
